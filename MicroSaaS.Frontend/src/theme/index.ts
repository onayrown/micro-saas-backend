...
// Configuração específica para tema claro
const lightTheme = createTheme({
  ...
  // Sombras suaves para o tema claro
  shadows: [
    'none',
...
const darkTheme = createTheme({
  palette: {
    ...
    ...commonColors,
    background: {
      default: '#121212', // Fundo padrão escuro
      paper: '#1E1E1E',   // Componentes com leve contraste
    },
    text: {
      primary: '#FFFFFF',
  ...
  // Sombras mais pronunciadas para o tema escuro
  shadows: [
    'none',
...
// Fábrica de temas para selecionar entre claro e escuro
